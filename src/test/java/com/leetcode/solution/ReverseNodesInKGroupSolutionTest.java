...
class ReverseNodesInKGroupSolutionTest {
    private ReverseNodesInKGroupSolution solution;

    @BeforeEach
    void setUp() {
        solution = new ReverseNodesInKGroupSolution();
    }
    ...
    void shouldEqualsListNode() {
        ...
        final ListNode resultNode3 = new ListNode(4);
        ...
        final ListNode result = solution.reverseKGroup(firstNode1, 2);
    ...
    void shouldReturnEmptyListNode() {
        ...
        final ListNode resultNode1 = new ListNode(3);
        ...
        final ListNode result = solution.reverseKGroup(firstNode1, 3);
