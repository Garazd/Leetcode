...
/**
 * <b>Binary Search Tree Iterator</b>
 * <p>Level: <i>Hard</i></p>
 *
 ...
 * That is, there will be at least a next number in the in-order traversal when next() is called.</p>
 *
 * @see <a href="https://leetcode.com/problems/binary-search-tree-iterator/description/">173. Binary Search Tree Iterator</a>
 */
